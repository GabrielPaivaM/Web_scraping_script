...
# Conta qual pesquisa esta sendo verificada.
c = 1
...
for i in range(1, int(number_of_last_page) + 1):
    ...
    with open('cnpq_data_portal_issn.csv', 'r', encoding='UTF-8') as r:
        reader = csv.reader(r)
        registers = list(reader)

    # Abre o arquivo em modo append para escrever o conteudo não existente.
    with open('cnpq_data_portal_issn.csv', 'a', newline='', encoding='UTF-8') as f:
        ...
        for article in articles:
            ...
            if article:
                ...
                print(f'{Fore.LIGHTRED_EX}Nenhum registro encontrado na pagina {Fore.LIGHTWHITE_EX}{i}.\n')
...
print(f'{Fore.LIGHTWHITE_EX}O tempo total gasto foi de {Fore.LIGHTYELLOW_EX}{total_elapsed_time:.2f}{Fore.LIGHTWHITE_EX} segundos.{Fore.WHITE}')